...
{
    if (!font.loadFromFile("/home/rohangajmer/KnuckleBones/assets/fonts/arial.ttf"))
    {
    ...
    if (!diceRollBuffer.loadFromFile("/home/rohangajmer/KnuckleBones/assets/sounds/dice-142528.wav"))
    {
        std::cerr << "Failed to load dice roll sound!" << std::endl;
        exit(1);
    }
